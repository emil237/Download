...
if [ $OS = "Opensource" ]; then
    ...
    wget "--no-check-certificate" "https://raw.githubusercontent.com/emil237/FootOnsat/main/enigma2-plugin-extensions-footonsat_$VERSION.deb?raw=true" -O "/tmp/enigma2-plugin-extensions-footonsat_$VERSION.deb";
