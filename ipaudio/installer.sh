#!/bin/sh
#wget -q "--no-check-certificate" https://raw.githubusercontent.com/emil237/Download/main/ipaudio/installer.sh -O - | /bin/sh
...
cd $TEMPATH
set -e
wget -q "https://raw.githubusercontent.com/emil237/Download/main/ipaudio/ipaudio-$version.tar.gz"
